...
class DetailFragment : Fragment() {
    ...
    private fun setupView(item: Item) {
        ...
        binding.fragmentDetailTextViewDate.text =
            item.data.firstOrNull()?.date_created?.toMyDateFormat() ?: "Fecha desconocida"

        Glide.with(requireActivity())
            .load(
                item.links.firstOrNull()?.href
                    ?: "https://image.freepik.com/free-vector/page-found-error-404_23-2147508324.jpg"
            )
            .centerCrop()
